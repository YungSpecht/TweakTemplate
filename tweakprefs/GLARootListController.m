...
-(void)respring {
    UIAlertController *respring = [UIAlertController alertControllerWithTitle:@"AwesomeTweak"
...
-(IBAction)twitterProfile {
    NSURL *URL = [NSURL URLWithString: @"[URL to your twitter Profile"];
